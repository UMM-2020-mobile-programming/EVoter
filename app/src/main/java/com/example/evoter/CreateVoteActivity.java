...
public class CreateVoteActivity extends AppCompatActivity {
    ...
    private Button btDatePicker, btDatePicker1,btn_crt_crt_back;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_create_vote);
        btn_crt_crt_back = (Button) findViewById(R.id.btn_crt_crt_back);
        ...
        btn_crt_crt_back.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent inte = new Intent(CreateVoteActivity.this,ProfilActivity.class);
                startActivity(inte);
            }
        });
    }
